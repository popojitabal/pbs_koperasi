            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_mst_karyawan" id="id_mst_karyawan" class="form-control form-control-sm selectize_this">
                            <option value="">--Pilih Jenis Laporan--</option>
                                <option value="">Laporan Pembelian</option>
                                <option value="">Laporan Pembayaran</option>
                                <option value="">Laporan Pinjaman</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-3">
                    <div class="form-group">
						...
						<p style="font-size: 14px; margin-bottom: 5px; color:gray;">Tanggal Mulai</p>
                ...
                <div class="col-3">
                    <div class="form-group">
						<label for="">.</label>
						<p style="font-size: 14px; margin-bottom: 5px; color:gray;">Tanggal Selesai</p>
                        <input step="any" type="datetime-local" class="form-control form-control-sm" name="tgl_pinjam" id="tgl_pinjam" value="<?=date('Y-m-d h:i:s')?>">
                    </div>
				</div>
